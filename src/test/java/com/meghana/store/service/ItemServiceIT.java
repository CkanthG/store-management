...
class ItemServiceIT {
    ...
    @Test
    void updateItem() throws EntityNotFoundException {
        ItemDto itemDto = new ItemDto("1", "item", 100.0, 1);
    ...
    @Test
    void getItemByItemIdEntityNotFoundException() {
    ...
    @Test
    void getItemsByNameGivesEmptyListIfThereIsNoItems() {
    ...
    @Test
    void deleteItem() throws EntityNotFoundException {
        ItemDto itemDto = new ItemDto("1", "item", 100.0, 1);
